...
export default async function SupplierCatalogPage() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-3xl mx-auto">
      <h1 className="text-2xl sm:text-3xl font-bold mb-1">Catalogo</h1>
      <p className="text-sm text-ink-muted mb-5 sm:mb-6">I prodotti visibili ai clienti collegati.</p>

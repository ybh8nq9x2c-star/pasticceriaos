...
export function NewOrderForm({
  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      ...
      {prefillNote && (
        <div className="mb-6 rounded-2xl bg-[#C9962A]/[0.08] border border-[#C9962A]/30 p-4">
          <p className="text-sm font-semibold text-[#8A6418]">📋 Bozza generata dal fabbisogno</p>
          <p className="text-xs text-[#6B7280] mt-1">{prefillNote}</p>
        </div>
      )}
      ...
      <form action={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-[#E5DDD0] p-6 space-y-5">
          ...
          <div>
            ...
            {suppliers.length === 0 && (
              <p className="text-xs text-[#C0392B] mt-1.5">
